        ...
        <section class="sidebar">
            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('backend', 'Manage Book'),
                        'options' => ['class' => 'header']
                    ],
                    [
                        'label' => Yii::t('backend', 'Book'),
                        'icon' => '<i class="fa fa-book"></i>',
                        'url' => ['/book/index'],
                    ],
                    [
                        'label' => Yii::t('backend', 'Book Category'),
                        'icon' => '<i class="fa fa-th-list"></i>',
                        'url' => ['/book-category/index'],
                    ],
                    [
                        'label' => Yii::t('backend', 'Book Shelf'),
                        'icon' => '<i class="fa fa-list-ol"></i>',
                        'url' => ['/book-shelf/index'],
                    ],
                    [
